...
rs=pd.DataFrame(np.array([Max1,Max2,Max3,Max4,tot]).transpose(),columns=['argmax','accuracy','communication cost','Battery Energy','time'])
rs.to_csv('SDG10epsi',index=False)
