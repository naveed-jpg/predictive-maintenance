...
plt.plot(df['Power'],color='red',label='Heating Power')
plt.xlabel('Time [10 min.]')
plt.ylabel('Heating Power [Watts]')
plt.legend()
#Data Normalisation
...
dfPower1=df[df['Power1']==1]
for i2 in range(10):
    dfPower=dfPower1.iloc[1600:2900,:]
    ...
    nn = NearestNeighbors(n_neighbors=K).fit(X_N)
    nn.fit(X_N,X_M)
    dist, index = nn.kneighbors(X_M,n_neighbors=K)
    ...
    rs.to_csv('/Users/inria/Desktop/Predictive Maintenance/constep/16002900semisupervised%i2'%i2,index=False)
    fig,ax=plt.subplots()
    ax.plot(Max2,'--*r')
    ax.set_xlabel('No. of Iterations')
    ax.set_ylabel('Accuracy')
J=pd.read_csv('/Users/inria/Desktop/Predictive Maintenance/constep/semisupervised29462')
K=pd.read_csv('/Users/inria/Desktop/Predictive Maintenance/constep/semisupervised20002')
L=pd.read_csv('/Users/inria/Desktop/Predictive Maintenance/constep/semisupervised10002')
M=pd.read_csv('/Users/inria/Desktop/Predictive Maintenance/constep/0000semisupervised12002')
N=pd.read_csv('/Users/inria/Desktop/Predictive Maintenance/constep/1500semisupervised29002')
O=pd.read_csv('/Users/inria/Desktop/Predictive Maintenance/constep/1001semisupervised25002')

fig1,ax1=plt.subplots()
ax1.plot(M['accuracy'],marker='*',linestyle='dashed',label='D_1')
ax1.plot(N['accuracy'],marker='*',linestyle='dashed',label='D_3')
ax1.plot(O['accuracy'],marker='*',linestyle='dashed',label='D_2')
